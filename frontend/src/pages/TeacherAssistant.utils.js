...
export const extractKnowledgeTags = (value) => {
    if (!value)
        return [];
    return value
        .split(/[;,，、\s]+/)
...
export const buildMistakeSummaryLine = (mistake) => {
...
export const extractAssistantSections = (content) => {
...
export const sortMistakesByRelevance = (items) => {
