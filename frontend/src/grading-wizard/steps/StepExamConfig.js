...
const StepExamConfig = () => {
    ...
    return (_jsxs(Space, { direction: "vertical", size: 24, style: { width: "100%" }, children: [_jsxs("div", { style: { display: "flex", justifyContent: "space-between", alignItems: "center" }, children: [_jsxs(Space, { direction: "vertical", size: 8, children: [_jsx(Title, { level: 3, style: { marginBottom: 0 }, children: "\u9009\u62E9\u8BD5\u5377\uFF0C\u5F00\u542F\u6279\u6539\u65C5\u7A0B" }), _jsx(Paragraph, { type: "secondary", style: { marginBottom: 0 }, children: "\u4ECE\u5DF2\u6709\u8BD5\u5377\u4E2D\u5FEB\u901F\u8FDB\u5165\u6279\u6539\uFF0C\u6216\u4E0A\u4F20\u626B\u63CF\u4EF6\u8BA9 AI \u81EA\u52A8\u89E3\u6790\u7ED3\u6784\u3002" })] }), _jsxs(Space, { size: 12, align: "center", children: [teachers.length === 0 ? (_jsx(Alert, { type: "warning", showIcon: true, message: "\u8BF7\u5148\u5728\u73ED\u7EA7\u642D\u5EFA\u4E2D\u521B\u5EFA\u6559\u5E08\u4FE1\u606F", description: "\u4E0A\u4F20\u8BD5\u5377\u9700\u8981\u7ED1\u5B9A\u6559\u5E08\u8D26\u53F7\uFF0C\u53EF\u5728\u73ED\u7EA7\u642D\u5EFA\u9875\u9762\u6DFB\u52A0\u3002" })) : (_jsx(Select, { style: { width: 220 }, placeholder: "\u9009\u62E9\u8D1F\u8D23\u6559\u5E08", value: teacherId ?? undefined, options: teacherOptions, onChange: (value) => {
                                ...
                                }, children: "\u914D\u7F6E\u5927\u6A21\u578B" }), _jsx(Button, { icon: _jsx(ReloadOutlined, {}), onClick: () => refreshExams(), loading: examsLoading, children: "\u5237\u65B0\u5217\u8868" }), _jsx(Button, { type: "primary", icon: _jsx(PlusOutlined, {}), onClick: () => setDraftModalOpen(true), disabled: !teacherId || !llmReady, children: "\u65B0\u5EFA\u8BD5\u5377" })] })] }), llmStatus === "unavailable" && (_jsx(Alert, { type: "warning", showIcon: true, message: "\u5C1A\u672A\u914D\u7F6E\u5927\u6A21\u578B API Key", description: "\u4E0A\u4F20\u626B\u63CF\u4EF6\u9700\u8981\u8C03\u7528 AI \u89E3\u6790\uFF0C\u8BF7\u5148\u5B8C\u6210\u914D\u7F6E\u3002", action: _jsx(Button, { size: "small", type: "primary", icon: _jsx(SettingOutlined, {}), onClick: () => setConfigVisible(true), children: "\u7ACB\u5373\u914D\u7F6E" }) })), _jsxs(Row, { gutter: 24, wrap: true, children: [_jsx(Col, { xs: 24, xl: 14, children: _jsx(Card, { title: "\u9009\u62E9\u5DF2\u6709\u8BD5\u5377", bodyStyle: { padding: 0 }, style: { borderRadius: 20 }, children: _jsx("div", { style: { padding: 20 }, children: examsLoading ? (_jsx("div", { style: { display: "flex", justifyContent: "center", padding: "80px 0" }, children: _jsx(Spin, { size: "large" }) })) : exams.length === 0 ? (_jsx(Empty, { image: Empty.PRESENTED_IMAGE_SIMPLE, description: teacherId ? "暂无试卷" : "请先选择负责教师" })) : (_jsx(List, { grid: { gutter: 16, column: 2 }, dataSource: exams, renderItem: (exam) => {
